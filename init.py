...
def __init__():
    ...
    subprocess.Popen('echo python3 -m venv slack_bot; source ./slack_bot/bin/activate;pip install --upgrade pip;pip install -r requirements.txt; deactivate;chmod +x main.py', shell=True, stdout=subprocess.PIPE)
